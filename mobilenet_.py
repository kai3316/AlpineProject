...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        features: List[nn.Module] = [ConvNormActivation(4, input_channel, stride=2, norm_layer=norm_layer,
                                                        activation_layer=nn.ReLU6)]
        ...
        # print(input_channel, self.last_channel)
        features.append(ConvNormActivation(input_channel, 12, kernel_size=1, norm_layer=None,activation_layer=None))
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        x = torch.nn.functional.interpolate(x, size=(13, 8), mode="bilinear", align_corners=True)
