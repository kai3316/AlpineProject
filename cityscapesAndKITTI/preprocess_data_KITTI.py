...
print(id_to_trainId_map_func)

cityscapes_data_path = "/home/kai/Desktop/KITTI/"
cityscapes_meta_path = "/home/kai/Desktop/KITTI/meta/"

fold_name = "label_imgs"
if not os.path.exists(cityscapes_meta_path):
    os.makedirs(cityscapes_meta_path)
if not os.path.exists(cityscapes_meta_path + "/"+fold_name):
    os.makedirs(cityscapes_meta_path + "/" + fold_name)
...
img_dir = cityscapes_data_path + "training/image_2/"
label_dir = cityscapes_data_path + "training/semantic_375_1242/"
...
for file_name in file_names:
    img_id = file_name
    # print(img_id)
    gtFine_img_path = label_dir + img_id
    ...
    # cv2.waitKey(0)
    # exit(0)
    cv2.imwrite(cityscapes_meta_path + "/"+fold_name+"/" + img_id, label_img)
    train_label_img_paths.append(cityscapes_meta_path + "/"+fold_name+"/" + img_id)
