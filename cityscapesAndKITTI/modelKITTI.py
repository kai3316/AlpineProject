...
class MobileNetV2(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        # print(output.shape)
        output = nn.functional.interpolate(output, size=(75, 207), mode='bilinear', align_corners=False)  # (shape: (batch_size, num_classes, h, w))
...
def mobilenet_v2(pretrained: bool = False, model_id: str = "", project_dir: str = "", progress: bool = True, **kwargs: Any) -> MobileNetV2:
    """
    ...
    """
    model = MobileNetV2(model_id=model_id, project_dir=project_dir, **kwargs)
    if pretrained:
