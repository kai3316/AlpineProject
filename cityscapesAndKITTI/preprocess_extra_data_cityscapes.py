...
trainExtra_dirs = ["augsburg/", "bad-honnef/", "bamberg/", "bayreuth/", "dortmund/", "dresden/", "duisburg/",
                   "erlangen/", "freiburg/", "heidelberg/", "heilbronn/", "karlsruhe/", "konigswinter/", "konstanz/",
                   "mannheim/", "muhlheim-ruhr/", "nuremberg/", "oberhausen/", "saarbrucken/", "schweinfurt/",
                   "troisdorf/", "wuppertal/", "wurzburg/"]

val_dirs = ["frankfurt/", "munster/", "lindau/"]
test_dirs = ["berlin", "bielefeld", "bonn", "leverkusen", "mainz", "munich"]

cityscapes_data_path = "/home/kai/Desktop/Cityscapes"
cityscapes_meta_path = "/home/kai/Desktop/Cityscapes/meta_extra"

if not os.path.exists(cityscapes_meta_path):
    os.makedirs(cityscapes_meta_path)
if not os.path.exists(cityscapes_meta_path + "/label_extra_imgs"):
    os.makedirs(cityscapes_meta_path + "/label_extra_imgs")
if not os.path.exists(cityscapes_meta_path + "/extra_imgs"):
    os.makedirs(cityscapes_meta_path + "/extra_imgs")
################################################################################
# convert all labels to label imgs with trainId pixel values (and save to disk):
################################################################################
train_label_img_paths = []

img_dir = cityscapes_data_path + "/extra/train_extra/"
label_dir = cityscapes_data_path + "/gtCoarse/train_extra/"
for train_dir in trainExtra_dirs:
    print(train_dir)
    ...
    for file_name in file_names:
        ...
        gtFine_img_path = train_label_dir_path + img_id + "_gtCoarse_labelIds.png"
        print(gtFine_img_path)
        rgbImage_path = train_img_dir_path + file_name
        rgb_img = cv2.imread(rgbImage_path, -1)
        ...
        cv2.imwrite(cityscapes_meta_path + "/label_extra_imgs/" + img_id + ".png", label_img)
        cv2.imwrite(cityscapes_meta_path + "/extra_imgs/" + img_id + ".png", rgb_img)
